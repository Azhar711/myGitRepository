...
$(document).ready(function() {
    ...
    $('.SizerLink').click(function() {
        var id = $(this).attr('id');
        $.cookie('selectedstyle', id);
    });
    ...
    $('#googleFonts2').attr('href', protocal + '//fonts.googleapis.com/css?family=Droid+Serif:400,700,400italic,700italic');
});
